package com.github.candidochan.citiesapi.cities.service;
...
import com.github.candidochan.citiesapi.cities.entities.City;
import com.github.candidochan.citiesapi.cities.repositories.CityRepository;
import java.util.Arrays;
import java.util.List;


import com.github.candidochan.citiesapi.utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        log.info("distanceUsingMath({}, {}, {})", (Object) city1, city2, unit);
